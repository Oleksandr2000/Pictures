...
/* harmony import */ var _modules_scroling__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/scroling */ "./src/js/modules/scroling.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_3__["default"])('[name = "phone"]'); // checkTextInputs('[name="name"]');
  // checkTextInputs('[name="message"]');

  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_4__["default"])('.button-styles', '#styles .row');
  Object(_modules_calculator__WEBPACK_IMPORTED_MODULE_5__["default"])('#size', '#material', '#options', '.promocode', '.calc-price');
  ...
  Object(_modules_scroling__WEBPACK_IMPORTED_MODULE_10__["default"])('.pageup');
});
...
var accordion = function accordion(trigersSelector) {
  var btns = document.querySelectorAll(trigersSelector); //   items = document.querySelectorAll(itemsSelector);
  // items.forEach(item => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calculator = function calculator(size, material, options, promocode, result) {
...
var scroling = function scroling(upSelector) {
  ...
  //             smoothScrol (scrollTop, hashElementTop, this.hash);
  //         }
  //     });
  // }
  // const smoothScrol = (from, to, hash) => {
  //     let timeInterval = 1,
  //         prevScrollTop,
  //         speed;
  //     if ( to > from){
...
/* harmony default export */ __webpack_exports__["default"] = (scroling);
...
var showMoreStyles = function showMoreStyles(triger, wrapper) {
  var trigerButton = document.querySelector(triger); // blockElements.forEach(elem => {
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  } catch (e) {} // function activateAnimation() {
  //     if (dir === 'vertical') {
